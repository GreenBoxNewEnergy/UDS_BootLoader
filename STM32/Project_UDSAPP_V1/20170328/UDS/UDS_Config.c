...
#endif
#if USE_RDBI_PN
    /* ReadDataByIdentifier PN */
    {ACCS_ALL, 0xF187, RdbiPN},
#endif
#if USE_RDBI_SID
    /* ReadDataByIdentifier SID */
    {ACCS_ALL, 0xF18A, RdbiSID},
#endif
#if USE_RDBI_ECUHW
...
#endif
#if USE_RDBI_AMT
    /* ReadDataByIdentifier MT */
    {ACCS_NO_PROG, 0x1100, RdbiAMT},
#endif
#if USE_RDBI_AIT
    /* ReadDataByIdentifier IT */
    {ACCS_NO_PROG, 0x1102, RdbiAIT},
#endif
#if USE_RDBI_AMS
    /* ReadDataByIdentifier AMS */
    {ACCS_NO_PROG, 0x1104, RdbiAMS},
#endif
#if USE_RDBI_AMTQ
    /* ReadDataByIdentifier AMTQ */
    {ACCS_NO_PROG, 0x1105, RdbiAMTQ},
#endif
#if USE_RDBI_MMTQ
    /* ReadDataByIdentifier MMTQ */
    {ACCS_NO_PROG, 0x1106, RdbiMMTQ},
#endif
#if USE_RDBI_AIC
    /* ReadDataByIdentifier AIC */
    {ACCS_NO_PROG, 0x1107, RdbiAIC},
#endif
#if USE_RDBI_RP
    /* ReadDataByIdentifier RP */
    {ACCS_NO_PROG, 0x1108, RdbiRP},
#endif
  },
#endif
#if USE_WR_DATA_BYID
...
#if USE_SEC_ACCS
  {ACCS_ALL, UDS_SEC_ACCS_REQ, UDS_TRUE, SecurityAccess},
#endif
...
#if USE_RD_DTC_INFO
  {ACCS_ALL, UDS_RD_DTC_INFO_REQ, UDS_TRUE, ReadDTCInformation},
#endif
